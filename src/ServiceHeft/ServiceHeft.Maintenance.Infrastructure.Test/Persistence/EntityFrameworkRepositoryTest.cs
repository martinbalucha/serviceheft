...
public class EntityFrameworkRepositoryTest
{
    ...
    {
        // Arrange
        var modelInfo = new Model("Citroen", "C5");
    ...
    public async Task ListAsync_NoStoredCars_EmptyCollectionReturned()
    {
        ...
        {
            new Car(Guid.NewGuid(), "VF701234567891234", new Model("Citroen", "C5"), DateTime.Now, "2AB0373", 193000, 
                    new Engine("2.0 HDI 163k", FuelType.Diesel, 1997, 120)),
            new Car(Guid.NewGuid(), "WBE01234567891234", new Model("BMW", "E46"), DateTime.Now, "2MA03479", 324000,
                    new Engine("M54", FuelType.Petrol, 2997, 170)),
            new Car(Guid.NewGuid(), "TEP01234567891234", new Model("Opel", "Insignia"), DateTime.Now, "2PT03479", 93000,
